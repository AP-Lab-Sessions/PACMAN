...
protected:
     ...
     */
    sf::Texture sheet;
    const int spritesPerRow, spritesPerColumn, horizontalPadding, verticalPadding, horizontalOffset, verticalOffset;
...
public:
     ...
     */
    SpriteSheet(const std::string& texturePath, const int& spritesPerRow, const int& spritesPerColumn,
                const int& horizontalPadding = 0, const int& verticalPadding = 0, const int& horizontalOffset = 0,
     ...
     * @return the sprite
     */
    sf::Sprite GetSprite(const int& x, const int& y, const PMGame::Logic::Coordinate2D::Coordinate& projected) const;
