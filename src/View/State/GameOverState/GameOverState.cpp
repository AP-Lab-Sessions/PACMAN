...
PMGame::View::GameOverState::GameOverState(const std::weak_ptr<sf::RenderWindow>& window)
    : State(window),
...
void PMGame::View::GameOverState::ProcessEvents(const sf::Event& event) {
...
void PMGame::View::GameOverState::Update() {}

void PMGame::View::GameOverState::Render() {
