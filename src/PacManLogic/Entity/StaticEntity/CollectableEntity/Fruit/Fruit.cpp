...
void Fruit::Accept(const std::weak_ptr<IEntityVisitor>& visitor) { visitor.lock()->Visit(*this); }

void Fruit::CollideWith(PMLogic::Entity& entity) { entity.CollideWith(*this); }