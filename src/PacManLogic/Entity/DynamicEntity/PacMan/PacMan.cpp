...
void PacMan::Accept(const std::weak_ptr<IEntityVisitor>& visitor) { visitor.lock()->Visit(*this); }
...
void PacMan::CollideWith(PMLogic::Entity& entity) { entity.CollideWith(*this); }